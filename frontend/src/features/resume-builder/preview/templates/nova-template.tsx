...
import { ResumePage, ResumeSectionTitle, ProfileImage, CompactSkills } from "../resume-page"
              ...
              <div>
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <div className="min-w-0">
                    <h1 className="text-[22px] font-bold leading-tight text-gray-900 mb-0.5 truncate">
