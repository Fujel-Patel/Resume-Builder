...
def _expiration(delta: Optional[timedelta], default_minutes: Optional[int] = None, default_days: Optional[int] = None) -> datetime:
...
def create_access_token(data: Dict[str, Any], expires_delta: Optional[timedelta] = None) -> str:
    ...
    """
    to_encode = data.copy()
    expire = _expiration(expires_delta, default_minutes=settings.JWT_ACCESS_EXPIRE_MINUTES)
